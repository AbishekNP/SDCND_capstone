...
class WaypointUpdater(object):
	...
	#Check if the closest waypoint is ahead or behind the vehicle:
	closest_cord = self.waypoints_2d[closest_idx]
	prev_cord = self.waypoints_2d[closest_idx-1]
	
	#Equation for the hyperplane through closest_coords:
	...
	if not self.waypoints_2d:
	    ...
	    self.waypoint_tree = KDTree(self.waypoints_2d)
            rospy.loginfo('waypoint _tree data = %s', self.waypoint_tree.data)
